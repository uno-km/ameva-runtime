...
class TtsAdapter(BaseAdapter):
    ...
    _PREFIX_BIN = Path(os.environ.get("PREFIX", "/data/data/com.termux/files/usr")) / "bin"

    CANDIDATE_VULKAN_BINARIES = [
        "sherpa-ncnn-offline-tts",
        "melo-mnn-cli",
        str(_PREFIX_BIN / "sherpa-ncnn-offline-tts"),
        str(_PREFIX_BIN / "melo-mnn-cli"),
    ...
    CANDIDATE_CPU_BINARIES = [
        ...
        str(_PREFIX_BIN / "sherpa-onnx-offline-tts"),
