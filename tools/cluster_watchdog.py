...
CONFIG_PATH = os.environ.get("AMEVA_CLUSTER_CONFIG", os.path.join(os.path.dirname(__file__), "cluster_config.json"))
if os.path.exists(CONFIG_PATH):
    with open(CONFIG_PATH, "r", encoding="utf-8") as f:
        DEVICES = json.load(f).get("devices", [])
else:
    DEVICES = [
        {"id": "192.168.1.101:5555", "name": "Galaxy S21 5G (Demo)", "type": "tcp"},
        {"id": "192.168.1.102:5555", "name": "Galaxy A53 5G (Demo)", "type": "tcp"},
        {"id": "192.168.1.103:5555", "name": "Galaxy A35 5G (Demo)", "type": "tcp"},
        {"id": "192.168.1.104:5555", "name": "Galaxy S20 5G (Demo)", "type": "tcp"},
        {"id": "DEMO_USB_SERIAL_001", "name": "Galaxy S7 (Demo)", "type": "usb"}
    ]
